...
async function processExpiredAccounts() {
  ...
  try {
    ...
    if (toKick.length > 0) {
      ...
      // Setiap akun launch persistent context-nya sendiri (lihat cookie-helper.js
      // launchAccountContext) — jadi tidak ada browser bersama yang perlu dijaga
      // di sini; kegagalan satu akun otomatis terisolasi lewat catch di bawah.
    ...
    if (toPinAll.length > 0) {
      ...
      // Sama seperti section kick: tiap akun launch persistent context-nya sendiri.
